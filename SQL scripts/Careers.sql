...
CREATE OR REPLACE PROCEDURE Matricula_DeleteCareer(idIn IN NUMBER)
AS
BEGIN
...
EXECUTE Matricula_InsertCareer('INFO2022','Ingenier�a en Sistema de Informaci�n', 'Bachillerato Universitario');
EXECUTE Matricula_InsertCareer('HISTO2022','Ense�anza de la Historia', 'Bachillerato Universitario');
COMMIT;
